...
TURRET12_ICON = game.image.load("Resources/turret_icon4.png").convert_alpha()
TURRET12_ICON = game.transform.scale(TURRET12_ICON, (7 * CELL, 7 * CELL))
TURRET13_ICON = game.image.load("Resources/turret_icon5.png").convert_alpha()
TURRET13_ICON = game.transform.scale(TURRET13_ICON, (7 * CELL, 7 * CELL))
TURRET14_ICON = game.image.load("Resources/turret_icon6.png").convert_alpha()
TURRET14_ICON = game.transform.scale(TURRET14_ICON, (7 * CELL, 7 * CELL))
PLAYER_TURRET12 = game.image.load("Resources/turret4.png").convert_alpha()
PLAYER_TURRET12 = game.transform.scale(PLAYER_TURRET12, (4 * CELL, 4 * CELL))
PLAYER_TURRET13 = game.image.load("Resources/turret5.png").convert_alpha()
PLAYER_TURRET13 = game.transform.scale(PLAYER_TURRET13, (4 * CELL, 4 * CELL))
PLAYER_TURRET14 = game.image.load("Resources/turret6.png").convert_alpha()
